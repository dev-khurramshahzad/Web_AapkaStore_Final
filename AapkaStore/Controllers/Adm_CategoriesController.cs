...
namespace AapkaStore.Controllers
{
    public class Adm_CategoriesController : Controller
    {
        ...
        public Adm_CategoriesController(DbAapkaStoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'DbAapkaStoreContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("CatId,Name,Image,Details,Status")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatId,Name,Image,Details,Status")] Category category)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbAapkaStoreContext.Categories'  is null.");
            }
            var category = await _context.Categories.FindAsync(id);
            if (category != null)
            {
